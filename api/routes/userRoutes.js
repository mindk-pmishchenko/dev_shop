...
router.post('/edit_personal_info/', authController.protect, userController.editPersonalInfo);
router.get('/get_user_data/', authController.protect, userController.getUserData);
...
router
    .route('/')
    .get(authController.protect, authController.restictTo(2), userController.getAllUsers);

router
    .route('/:id')
    .patch(authController.protect, authController.restictTo(2), baseController.updateItem('users'))
    .delete(
        authController.protect,
